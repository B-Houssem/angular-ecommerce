...
export class ProductListComponent implements OnInit{
  ...
  processResult(){
    ...
    //the content in handleListProducts the last part that's preceeded by this comment:
    //now get the products for the given category id...
    //inside the subscribe() is similar to processResult() content so we refactor it
  }
